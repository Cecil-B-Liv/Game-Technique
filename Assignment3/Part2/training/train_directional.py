...
def train_directional_ppo():
    """Train PPO agent with directional controls - saves ONLY the best model."""
    ...
    env = make_vec_env(
        DirectionalEnv,
        n_envs=n_envs,
        monitor_dir="./logs/directional_train_monitor"
    )
    
    eval_env = make_vec_env(
        DirectionalEnv,
        n_envs=1,
        monitor_dir="./logs/directional_eval_monitor"
    )
    ...
    eval_callback = EvalCallback(
        ...
        log_path="./logs/directional_eval/",
